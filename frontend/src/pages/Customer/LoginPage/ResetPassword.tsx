          ...
          >
            <div className="relative group">
              <Input.Password
                placeholder=" "
                style={styles.input}
                className="w-full !rounded-lg !border !border-gray-300 !bg-gray-100 focus-within:!border-[#5cdb95] focus-within:!bg-white focus-within:shadow-[0_0_0_1px_#5cdb95] transition-all duration-150"
              />
...
const styles = {
  ...
  button: {
    ...
    boxShadow: "0 2px 4px rgba(55, 150, 131, 0.25)",
  },
};
