        ...
        <div className="relative w-full max-w-3xl bg-white rounded-2xl shadow-2xl overflow-hidden border-2 border-gray-200">
          ...
          <div className="relative h-[460px] w-full bg-black">
            ...
            <div className="relative z-10 flex h-full items-center justify-center">
              ...
              >
                <div
                  className={`relative bg-linear-to-br from-[#5cdb95]/90 to-[#379683]/90 px-5 text-[#05386b] transition-all duration-200 ease-in-out ${
                      ...
                      <div>
                        <div className="relative">
                          ...
                          <input
                            ...
                            placeholder=" "
                              className="peer w-full rounded-lg border-2 border-gray-300 bg-white text-gray-900 text-sm pl-9 pr-3 py-2.5 transition-all duration-150 focus:outline-none focus:border-[#5cdb95] focus:bg-white"
                            required
                            disabled={isLoading}
                          />
                        ...
                        <div>
                          <div className="relative">
                            ...
                            <input
                              ...
                              placeholder=" "
                              className="peer w-full rounded-lg border-2 border-gray-300 bg-white text-gray-900 text-sm pl-9 pr-9 py-2.5 transition-all duration-150 focus:outline-none focus:border-[#5cdb95] focus:bg-white"
                              required
                              disabled={isLoading}
                            />
                            <label className="pointer-events-none absolute left-9 top-1/2 -translate-y-1/2 rounded-full bg-white px-1 text-sm text-gray-600 border-2 border-transparent z-10 transition-all duration-150 peer-focus:bg-white peer-not-placeholder-shown:bg-white peer-not-placeholder-shown:border-gray-300 peer-focus:border-[#5cdb95] peer-focus:top-0 peer-focus:-translate-y-1/2 peer-focus:text-[0.65rem] peer-focus:text-[#05386b] peer-focus:font-semibold peer-not-placeholder-shown:top-0 peer-not-placeholder-shown:-translate-y-1/2 peer-not-placeholder-shown:text-[0.65rem] peer-not-placeholder-shown:text-[#05386b] peer-not-placeholder-shown:font-semibold">
